...
class ExtremalMask(PerturbationAttribution):
    ...
    def attribute(
        ...
        # When using deletion mode the most imporant features are masked
        # this means m=0, following the notation in the paper, however,
        # the code assumes m=1 are the most imporant features
        if not preservation_mode:
